...
This repository is provided under the MIT License by default — please replace or confirm the license in `LICENSE` if you have specific legal needs.

## Contact & Acknowledgements

Created and maintained by the repository owner. If you'd like help shaping the README or adjusting examples to match the code, I can update the README to reference concrete module names and notebook paths — just tell me which files or entrypoints to use. Thanks for exploring ADMS — happy mapping!